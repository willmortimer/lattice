...
PCM audio stream
    ↓
latticed voice session (or in-process prototype)
    ↓
FluidAudio
    ↓
...
Buffered utterance
    ↓
Parakeet Unified offline re-decode
    ↓
...
- **FluidAudio** — Apple-native inference framework
- **Parakeet Unified English Core ML** — initial speech-recognition model
- Streaming recognition for provisional UX; offline re-decode for authoritative text
