...
pub use download::{
    ...
    pinned_model_is_ready, progress_total_hint, semantic_fake_enabled,
    semantic_model_source_override, AcquireResult, ProgressFn, ENV_SEMANTIC_FAKE,
    ENV_SEMANTIC_MODEL_SOURCE,
};
