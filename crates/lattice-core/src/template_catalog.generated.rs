...
pub(crate) static GENERATED_TEMPLATES: &[GeneratedTemplate] = &[
    ...
    GeneratedTemplate {
        ...
        preview: &["Home.md", "Research/Local Runtime.md", "Research/Long Read.md", "Product/Vision.md", "CRM.data", "Projects/Delivery.data", "Data/Metrics.data", "Data/Events.dataset", "Data/Orders.dataset", "Data/Places.dataset", "Dashboards/Signups by region.vl.json", "Dashboards/Revenue by region and category.vl.json", "Dashboards/Revenue by day.vl.json", "Dashboards/Revenue by channel.vl.json", "OKRs.data", "Canvases/Product Strategy.canvas", "Inbox/Sample capture.md", "Templates/Daily Note.md", "Notebooks/CRM exploration.ipynb", "Notebooks/Orders analytics.ipynb", "Resources/"],
        capabilities: &["pages", "canvas", "sqlite"],
        quick_note_directory: "Inbox",
        daily_note_directory: None,
        attachments_directory: None,
