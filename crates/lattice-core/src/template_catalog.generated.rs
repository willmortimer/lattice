...
pub(crate) static GENERATED_TEMPLATES: &[GeneratedTemplate] = &[
    ...
    GeneratedTemplate {
        ...
        preview: &["Home.md", "Research/Long Read.md", "Product/Vision.md", "Product/Principles.md", "CRM.data", "Canvases/Product Strategy.canvas", "Inbox/Sample capture.md", "Templates/Daily Note.md", "Resources/"],
        capabilities: &["pages", "canvas", "sqlite"],
        quick_note_directory: "Inbox",
        daily_note_directory: None,
        attachments_directory: None,
