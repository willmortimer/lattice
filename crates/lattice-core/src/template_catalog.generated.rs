...
pub(crate) static GENERATED_TEMPLATES: &[GeneratedTemplate] = &[
    ...
    GeneratedTemplate {
        ...
        name: "First Look",
        category: "Sample",
        description: "Kitchen-sink sample: CRM + Delivery + Metrics + OKRs data apps, Events.dataset + Orders.dataset (DuckDB Parquet + Vega-Lite), canvas, notebooks, hybrid search try-queries, voice/Quick Note tips, daemon runtime diagram, templates, and assorted files.",
        visibility: "sample",
        recommended: false,
