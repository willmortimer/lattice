...
pub(crate) static GENERATED_TEMPLATES: &[GeneratedTemplate] = &[
    ...
    GeneratedTemplate {
        ...
        preview: &["Home.md", "Brief.md", "Plan.md", "Milestones.canvas", "Outputs/Project Review.deck", "Decisions/0001 Example decision.md", "Decisions/", "Meetings/", "Working/"],
        capabilities: &["pages", "canvas", "sqlite", "deck"],
        ...
        files: &[
            ...
            SeedFile { path: "Outputs/Project Review.deck/deck.yaml", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/project/files/Outputs/Project Review.deck/deck.yaml")) },
            SeedFile { path: "Outputs/Project Review.deck/slides/001-title.html", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/project/files/Outputs/Project Review.deck/slides/001-title.html")) },
            SeedFile { path: "Outputs/Project Review.deck/slides/002-progress.html", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/project/files/Outputs/Project Review.deck/slides/002-progress.html")) },
            SeedFile { path: "Outputs/Project Review.deck/notes/001-title.md", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/project/files/Outputs/Project Review.deck/notes/001-title.md")) },
            SeedFile { path: "Outputs/Project Review.deck/theme.css", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/project/files/Outputs/Project Review.deck/theme.css")) },
    ...
    GeneratedTemplate {
        ...
        files: &[
            ...
            SeedFile { path: "Hackathon/Pitch.deck/deck.yaml", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/deck.yaml")) },
            SeedFile { path: "Hackathon/Pitch.deck/theme.css", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/theme.css")) },
            SeedFile { path: "Hackathon/Pitch.deck/slides/001-title.html", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/slides/001-title.html")) },
            SeedFile { path: "Hackathon/Pitch.deck/slides/002-problem.html", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/slides/002-problem.html")) },
            SeedFile { path: "Hackathon/Pitch.deck/slides/003-product.html", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/slides/003-product.html")) },
            SeedFile { path: "Hackathon/Pitch.deck/slides/004-traction.html", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/slides/004-traction.html")) },
            SeedFile { path: "Hackathon/Pitch.deck/slides/005-ask.html", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/slides/005-ask.html")) },
            SeedFile { path: "Hackathon/Pitch.deck/notes/001-title.md", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/notes/001-title.md")) },
            SeedFile { path: "Hackathon/Pitch.deck/notes/002-problem.md", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/notes/002-problem.md")) },
            SeedFile { path: "Hackathon/Pitch.deck/notes/005-ask.md", bytes: include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/../../templates/workspaces/demo/files/Hackathon/Pitch.deck/notes/005-ask.md")) },
        ...
        data_packages: &[
            ...
            rows_json: &[
                ...
                "{\"name\":\"Presentation bookmarks and ordered scenes\",\"area\":\"Publishing\",\"status\":\"Backlog\",\"priority\":\"Medium\",\"owner\":\"Product\",\"due\":\"2026-08-18\",\"notes\":\"Hackathon/Pitch.deck is the presenter-native close; Pitch.canvas remains the spatial storyboard.\"}",
            ...
            rows_json: &[
                ...
                "{\"name\":\"Pitch canvas close\",\"workstream\":\"Story\",\"owner\":\"Demo\",\"status\":\"Ready\",\"due\":\"2026-07-25\",\"demo_risk\":\"Low\",\"notes\":\"Use Hackathon/Pitch.deck in presentation mode; keep Pitch.canvas for the spatial storyboard.\"}"
            ],
            extra_tables: &[
                SeedDataExtraTable {
                table: "sponsors",
