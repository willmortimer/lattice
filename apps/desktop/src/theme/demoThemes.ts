...
/**
 * Mirrors each theme YAML's `font_pack:`. Themes absent here follow `lattice`.
 * `demoThemes.test.ts` fails if this drifts from `themes/*.theme.yaml`.
 */
export const THEME_DEFAULT_FONT_PACKS: Record<string, string> = {
  "lattice-carbon": "foundry",
  "lattice-fjord": "signal",
  "lattice-ultraviolet": "meridian",
  "lattice-blueprint": "transit",
  "lattice-vellum": "atelier",
  "lattice-ember": "draft",
  "lattice-moss": "grove",
  "lattice-midnight": "foundry",
  "lattice-copper": "atelier",
  "lattice-rosewood": "draft",
  "lattice-graphite": "console",
  "lattice-glacier": "signal",
  "lattice-sandstone": "almanac",
  "lattice-orchid": "marquee",
  "lattice-meadow": "grove",
  "lattice-porcelain": "instrument",
  "lattice-matcha": "almanac",
  "lattice-solar-flare": "bulletin",
  "lattice-tidepool": "meridian",
  "lattice-limestone": "ledger",
  "lattice-daylight": "legible",
  "lattice-dusk": "atelier",
  "lattice-monochrome": "teletype",
  cupertino: "apple",
  "lattice-oled": "console",
  "catppuccin-mocha": "meridian",
  nord: "signal",
  "github-dark": "foundry",
  dracula: "bulletin",
  "solarized-dark": "teletype",
  "tokyo-night": "meridian",
  "gruvbox-dark": "grove",
  "one-dark": "console",
  "rose-pine-moon": "draft",
  "kanagawa-wave": "almanac",
  "everforest-dark": "grove",
  "ayu-dark": "transit",
};
...
> = {
  ...
  "lattice-daylight": {
    ...
    vars: variantVars({
      ...
      "--lt-faint": "#6b7285",
      "--lt-accent": "#1d4ed8",
      "--lt-accent-bright": "#1233a8",
      "--lt-accent-deep": "#0d2578",
      "--lt-danger": "#a4161a",
      "--lt-shadow": "#05070c",
      "--lt-on-accent": "#ffffff",
      "--lt-radius": "6px",
  ...
  "lattice-dusk": {
    ...
    vars: variantVars({
      ...
      "--lt-faint": "#69717f",
      "--lt-accent": "#e0a458",
      "--lt-accent-bright": "#f3c68b",
      "--lt-accent-deep": "#b57f37",
      "--lt-danger": "#e88b7d",
      "--lt-shadow": "#0b0d11",
      "--lt-on-accent": "#1e1509",
      "--lt-radius": "10px",
  ...
  "lattice-monochrome": {
    ...
    vars: variantVars({
      ...
      "--lt-faint": "#616161",
      "--lt-accent": "#e4e4e4",
      "--lt-accent-bright": "#ffffff",
      "--lt-accent-deep": "#a8a8a8",
      "--lt-danger": "#ff6b5e",
      "--lt-shadow": "#000000",
      "--lt-on-accent": "#0b0b0b",
      "--lt-radius": "4px",
  ...
  "everforest-dark": {
    ...
    vars: variantVars({
      ...
      "--lt-faint": "#7a8478",
      "--lt-accent": "#a7c080",
      "--lt-accent-bright": "#c3d9a0",
      "--lt-accent-deep": "#83a05c",
      "--lt-danger": "#e67e80",
      "--lt-shadow": "#1e2326",
      "--lt-on-accent": "#2d353b",
      "--lt-term-black": "#343f44",
      "--lt-term-red": "#e67e80",
      "--lt-term-green": "#a7c080",
      "--lt-term-yellow": "#dbbc7f",
      "--lt-term-blue": "#7fbbb3",
      "--lt-term-magenta": "#d699b6",
      "--lt-term-cyan": "#83c092",
      "--lt-term-white": "#d3c6aa",
      "--lt-term-bright-black": "#859289",
      "--lt-term-bright-red": "#e67e80",
      "--lt-term-bright-green": "#a7c080",
      "--lt-term-bright-yellow": "#dbbc7f",
      "--lt-term-bright-blue": "#7fbbb3",
      "--lt-term-bright-magenta": "#d699b6",
      "--lt-term-bright-cyan": "#83c092",
      "--lt-term-bright-white": "#d3c6aa",
      "--lt-term-cursor": "#d3c6aa",
      "--lt-term-cursor-text": "#2d353b",
      "--lt-term-selection": "#475258",
    }),
  },
  "ayu-dark": {
    name: "Ayu Dark",
    ...
    vars: variantVars({
      ...
      "--lt-faint": "#565b66",
      "--lt-accent": "#ffb454",
      "--lt-accent-bright": "#ffd580",
      "--lt-accent-deep": "#e5892e",
      "--lt-danger": "#f07178",
      "--lt-shadow": "#04070c",
      "--lt-on-accent": "#0b0e14",
      "--lt-radius": "8px",
      "--lt-radius-sm": "5px",
      "--lt-radius-lg": "13px",
      "--lt-term-black": "#01060e",
      "--lt-term-red": "#ea6c73",
      "--lt-term-green": "#91b362",
      "--lt-term-yellow": "#f9af4f",
      "--lt-term-blue": "#53bdfa",
      "--lt-term-magenta": "#fae994",
      "--lt-term-cyan": "#90e1c6",
      "--lt-term-white": "#c7c7c7",
      "--lt-term-bright-black": "#686868",
      "--lt-term-bright-red": "#f07178",
      "--lt-term-bright-green": "#aad94c",
      "--lt-term-bright-yellow": "#ffb454",
      "--lt-term-bright-blue": "#59c2ff",
      "--lt-term-bright-magenta": "#ffee99",
      "--lt-term-bright-cyan": "#95e6cb",
      "--lt-term-bright-white": "#f3f3f3",
      "--lt-term-cursor": "#ffb454",
      "--lt-term-cursor-text": "#0b0e14",
      "--lt-term-selection": "#409fff2b",
    }),
  },
};
