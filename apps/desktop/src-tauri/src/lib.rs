...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(app_lock::gated_invoke_handler(tauri::generate_handler![
            ...
            workspace_backup::list_account_cloud_workspaces_cmd,
            workspace_backup::list_encrypted_backups_for_cloud_workspace_cmd,
            workspace_backup::restore_encrypted_backup_for_cloud_workspace_cmd,
